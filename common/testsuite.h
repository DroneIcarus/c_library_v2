...
static void mavlink_test_charging_mav_info(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_CHARGING_MAV_INFO >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_charging_mav_info_t packet_in = {
        17.0,45.0,73.0,101.0,129.0,157.0,185.0,213.0,241.0,269.0
    };
    mavlink_charging_mav_info_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.AvgVCell_V = packet_in.AvgVCell_V;
        packet1.AvgCell3_V = packet_in.AvgCell3_V;
        packet1.AvgCell2_V = packet_in.AvgCell2_V;
        packet1.AvgCell1_V = packet_in.AvgCell1_V;
        packet1.RepCap_mAh = packet_in.RepCap_mAh;
        packet1.Current_mA = packet_in.Current_mA;
        packet1.AvgCurrent_mA = packet_in.AvgCurrent_mA;
        packet1.TTE_hr = packet_in.TTE_hr;
        packet1.TTF_hr = packet_in.TTF_hr;
        packet1.RepSOC_Pourcent = packet_in.RepSOC_Pourcent;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_CHARGING_MAV_INFO_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_CHARGING_MAV_INFO_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_charging_mav_info_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_charging_mav_info_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_charging_mav_info_pack(system_id, component_id, &msg , packet1.AvgVCell_V , packet1.AvgCell3_V , packet1.AvgCell2_V , packet1.AvgCell1_V , packet1.RepCap_mAh , packet1.Current_mA , packet1.AvgCurrent_mA , packet1.TTE_hr , packet1.TTF_hr , packet1.RepSOC_Pourcent );
    mavlink_msg_charging_mav_info_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_charging_mav_info_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.AvgVCell_V , packet1.AvgCell3_V , packet1.AvgCell2_V , packet1.AvgCell1_V , packet1.RepCap_mAh , packet1.Current_mA , packet1.AvgCurrent_mA , packet1.TTE_hr , packet1.TTF_hr , packet1.RepSOC_Pourcent );
    mavlink_msg_charging_mav_info_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_charging_mav_info_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_charging_mav_info_send(MAVLINK_COMM_1 , packet1.AvgVCell_V , packet1.AvgCell3_V , packet1.AvgCell2_V , packet1.AvgCell1_V , packet1.RepCap_mAh , packet1.Current_mA , packet1.AvgCurrent_mA , packet1.TTE_hr , packet1.TTF_hr , packet1.RepSOC_Pourcent );
    mavlink_msg_charging_mav_info_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_charging_mav_info(system_id, component_id, last_msg);
